...
const Footer = () => {
  return (
    <div className='flex gap-5 w-full h-screen bg-zinc-900 font-["Founders_Grotesk"]'>
        <div className='w-1/2 h-full mt-10 p-20 flex flex-col justify-between '>
            <div className="heading">
                <h1 className='text-[8vw] uppercase font-semibold font-["Founders_Grotesk"] -mb-10 leading-none tracking-tighter'>eye-</h1>
                <h1 className='text-[8vw] uppercase font-semibold font-["Founders_Grotesk"] -mb-10 leading-none tracking-tighter'>opening</h1>
            </div>
        ...
        <div className='w-1/2 h-full mt-20 p-20'>
        <h1 className='text-[5.5vw] uppercase font-semibold font-["Founders_Grotesk"] -mb-10 leading-none tracking-tighter'>Presentations</h1>

        <div className='links mt-32 flex flex-col text-3xl font-["Neue_Montreal"]'>
            <h1 className='mb-10'>s:</h1>
            <a href="#">Facebook</a>
            <a href="#">Instragram</a>
            <a href="#">Twitter</a>
            <a className='mb-10' href="#">Linkedin</a>

            <h1 className='mb-10'>L:</h1>
                <a href="#">202-1965 W 4th Ave</a>
                <a href="#">Vancouver, Canada</a>
                <a href="#">30 Chukarina St</a>
                <a className='mb-10' href="#">Lviv, Ukraine</a>
        </div>
        </div>
